...
<head>
    ...
    <title>NFC IET - Recover Password</title>
</head>
        ...
        <div class="body-con">
            <div class="box">
                ...
                <form action="recover.php" method="POST">
                    ...
                    <div class="input">
                        <i class="fas fa-lock"></i>
                        <input type="password" name="password1" placeholder="Enter Password" autocomplete="off">
                    </div>
                    <div class="input">
                        <i class="fas fa-lock"></i>
                    ...
                    <button type="submit" name="recover">Recover Now</button>
                </form>
