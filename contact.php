...
<head>
    ...
    <title>NFC IET - Contact Form</title>
</head>
        ...
        <div class="body-con">
            <div class="box">
                ...
                <form action="contact.php" method="POST">
                    ...
                    <textarea name="c_msg" cols="30" rows="7" placeholder="Message.! (Max 255 Words)" maxlength="255"></textarea>
                    <h3 class="link">Have any Complain?
